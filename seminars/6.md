...
* The code for comparing this algorithm with the previous one is here [\faPython](https://hal.science/hal-01056171v2/document)
...
$$
Let's show idea how to reduce the first to the second.
:::
