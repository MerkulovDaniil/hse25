...
## Problem 2. Projection onto probability simplex [\faFilePdf](https://angms.science/doc/CVX/Proj_simplex.pdf)
...
## Problem 2 solution: using duality problem [\faFilePdf](https://angms.science/doc/CVX/Proj_simplex.pdf)
...
## Problem 2 solution: using duality problem
...
## Problem 2 solution: another algorithm $\mathcal{O}(n)$ (?) [\faFilePdf](https://stanford.edu/~jduchi/projects/jd_ss_ys_paper.pdf)
...
TODO: add a description of the difference between 2 and 1 algorithms and also the code for comparing them (already written, need to create a notebok)

TODO: add the reduction of the projection problem on the l_1 ball to the projection problem on the probabilistic simplex

TODO: add a description of the dual SVM problem, how it helps to solve primal
